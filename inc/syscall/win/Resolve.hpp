...
namespace cmn::syscall::win_
{
    ...
    const PEB                    *PROCESS_ENV_BLOCK;

    const void                   *NTDLL;
    const IMAGE_EXPORT_DIRECTORY *EXPORT_DIRECTORY;
    const u32                    *EXPORT_NAMES;
    const u32                    *EXPORT_FUNCTIONS;
    const u16                    *EXPORT_ORDINALS;
          u32                     EXPORT_COUNT;


    const PEB *resolve_peb()// TODO: move to Resolve.cpp.
    {
        PEB *_peb;
    ...
    const void *resolve_library(const c08 *_libraryName) // TODO: move to Resolve.cpp.
    {
    ...
    void *resolve_proc_address(const char* _func, const s64 _funcLength) // TODO: move to Resolve.cpp.
    {
