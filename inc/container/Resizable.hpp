...
namespace cmn::container
{
    ...
    {
public:
        void append_copy(const TYPE_  &_element                  ) {static_cast<CONTAINER_>(this)->append_copy__(_element        );}
        void append_move(      TYPE_ &&_element                  ) {static_cast<CONTAINER_>(this)->append_move__(_element        );}
        void insert_copy(const TYPE_  &_element, const s64 _index) {static_cast<CONTAINER_>(this)->insert_copy__(_element, _index);}
